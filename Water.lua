...
local function getRandomWanderPosition(currentPosition)
...
local function clampToWanderArea(pos)
...
local function tweenSharkTo(shark, position, constrain)
...
local function applySharkTrait(animal)
...
local function fireBurst(sharkName, animal)
...
local function wanderShark(shark)
...
local function attackLoop(shark)
    while isActive and shark.Parent do
...
local function createSharkHitbox(sharkType)
...
local function spawnShark(sharkType)
